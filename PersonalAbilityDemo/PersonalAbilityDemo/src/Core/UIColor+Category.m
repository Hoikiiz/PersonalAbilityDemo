...
{
    return [UIColor colorWithHue:self.hueValue saturation:self.saturationValue brightness:self.brightnessValue * 0.8 alpha:self.alphaForHSBValue];
}
